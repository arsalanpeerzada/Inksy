...
internal class PhotoEditorImpl @SuppressLint("ClickableViewAccessibility") constructor(
    ...
    override fun addImage(
        ...
        val multiTouchListener = getMultiTouchListener(isEnabled)
        val sticker = Sticker(photoEditorView, multiTouchListener, viewState, mGraphicManager,isEnabled)
        sticker.buildView(desiredImage)
        addToEditor(sticker, axixX, axixY, width, height, viewtag,isEnabled)
    ...
    override fun addText(
        ...
        addText(text, styleBuilder, axixX, axixY, width, height,viewtag, _onMoveListener, isEnabled)
    ...
    override fun addText(
        ...
        addToEditor(textGraphic, axixX, axixY, width, height, viewtag, isEnabled)
    ...
    override fun addEmoji(emojiTypeface: Typeface?, emojiName: String?) {
        ...
        addToEditor(emoji, 0f, 0f, 0f, 0f, "", true)
    }
    ...
    private fun addToEditor(
        ...
        myisEnabled = isEnabled
        clearHelperBox()
        mGraphicManager.addView(graphic, axixX, axixY, width, height, viewtag, isEnabled)
