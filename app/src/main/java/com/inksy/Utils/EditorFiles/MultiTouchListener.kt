...
internal class MultiTouchListener(
    ...
    private val isRotateEnabled = isEnabled
    private val isTranslateEnabled = isEnabled
    private val isScaleEnabled = isEnabled
...
//                }
    ...
    private inner class ScaleGestureListener : ScaleGestureDetector.SimpleOnScaleGestureListener() {
        ...
        override fun onScale(view: View, detector: ScaleGestureDetector): Boolean {
            ...
            info.viewTag = view.tag as String?
            move(view, info)
...
//    }
    ...
    companion object {
        ...
        private fun move(view: View, info: TransformInfo) {
            ...
            info.deltaAngle = rotation
            info.deltaScale = scale
