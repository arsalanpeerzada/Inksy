...
class FirstBookAdapter(
    ...
    class ViewHolder(itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        lateinit var itembook: ConstraintLayout
        ...
        fun bind() {
            ...
            emptyImage = itemView.findViewById(R.id.create_journal)
            emptyText = itemView.findViewById(R.id.emptyIDText)
            itembook = itemView.findViewById(R.id.itemBook)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (list[position].title != "@@@@") {
            ...
            holder.emptyImage.visibility = View.VISIBLE
            holder.emptyText.visibility = View.VISIBLE
            holder.itembook.visibility = View.GONE
        }
    }
