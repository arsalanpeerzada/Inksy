...
import com.inksy.UI.Activities.ShowPage
...
import com.inksy.databinding.FragmentShowPageBinding
...
class ShowPageFragment : Fragment(), iOnClickListerner, OnPhotoEditorListener,
    ...
    lateinit var binding: FragmentShowPageBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        binding = FragmentShowPageBinding.inflate(layoutInflater)
        ...
        var childname = bundle!!.getString("data")
        var createdby = bundle.getInt("createdby").toString()
        pageId = childname?.toInt()!!


        if (createdby == tinyDB.getString("id")){
        ...
        var id = journalDatabase.getJournalData()


        var data = journalDatabase.getJournalData().getOnePage(childname.toString())
             ...
             if (indexdata != null) {
                 ...
                 if (indexdata.arrayOfImage != null && indexdata.arrayOfImage != "[]") {
                     ...
                     for (l in 0 until imagearray) {
                         ...
                         val axix = imageJsonObject.getString("axixX")
                         val axiy = imageJsonObject.getString("axixY")
                         val viewtag: String
                         val info: String
                         val axixY: String
                         val axixX: String
                         ...
                         val width: String
                         if (axix != "0" && axiy != "0") {
                             width = imageJsonObject.getString("width")
                             height = imageJsonObject.getString("height")
                             bit = imageJsonObject.getString("bitmap")
                             axixX = imageJsonObject.getString("axixX")
                             axixY = imageJsonObject.getString("axixY")
                             info = imageJsonObject.getString("info")
                             viewtag = imageJsonObject.getString("viewtag")
                         } else {
                             width = "0"
                             height = "0"
                             bit = imageJsonObject.getString("bitmap")
                             ...
                             viewtag = imageJsonObject.getString("viewtag")
                             info =
                                 "{\"deltaAngle\":-0.030428812,\"deltaScale\":0.58436143,\"deltaX\":0.002319336,\"deltaY\":0.86535645,\"maximumScale\":10.0,\"minimumScale\":0.5,\"pivotX\":433.71832,\"pivotY\":671.94116,\"viewTag\":\"IMAGE_680\"}"
                             ...
                             .into(object : CustomTarget<Bitmap>() {
                                 override fun onResourceReady(
                                     ...
                                     mPhotoEditor.addImage(
                                         ...
                                         axixY.toFloat(),
                                         width.toFloat(),
                                         height.toFloat(), viewtag, object : onMoveListener {
 ...
 //                                                }
    ...
    fun init() {
        val pinchTextScalable =
            requireActivity().intent.getBooleanExtra(PINCH_TEXT_SCALABLE_INTENT_KEY, false)
    ...
    private fun onTextCreateMethod() {
        ...
        textEditorDialogFragment.setOnTextEditorListener(object :
            ...
            override fun onDone(
                ...
                if (_typface != 0) {
                    val typeface = requireActivity().resources?.getFont(_typface)
                    styleBuilder.withTextFont(typeface!!)
                }
...
//        }
    ...
    private fun openRoundBottomSheet(pages: Int) {
        ...
        var _adapter = PagesAdapter(requireContext(), list, object : iOnClickListerner {
            override fun onclick(position: Int) {
                super.onclick(position)
                var pos = position.plus(1)
                startActivity(
                    Intent(requireContext(), ShowPage::class.java).putExtra(
                        "Page",
                        pos
                    )
                )
